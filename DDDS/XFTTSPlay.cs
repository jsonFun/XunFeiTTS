/* ========================================================================
  * 类名称(Class Name)          ： XFTTSPlay
  * 
  * 类描述(Description)         ： 
  * 
  * 创建人(Author)              ： fangtao
  *
  * 创建时间（Create Date）     ： 2019/5/29 22:46:28
  * 
...
namespace DDDS
{
    public static class XFTTSPlay
    {
        ...
        public static void NewMethod(string txt)
        {
            ...
            {
               // MessageBox.Show(txt + " - 语音文件保存失败。");
                //Log.WriteLog(LogFile.Trace, "语音文件保存失败" + ex.ToString());
            }
            finally
            {
